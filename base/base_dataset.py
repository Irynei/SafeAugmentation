...
class AutoAugmentDataset(data.Dataset):
    ...
    """
    def __init__(self, dataset, base_transforms, all_augmentations):
    ...
    def get_subset_of_transforms(self):
        ...
        """
        all_transforms_size = len(self.all_augmentations)
        subset_transforms = []
        ...
        for i in transform_idx:
            subset_transforms.append(self.all_augmentations[i])
